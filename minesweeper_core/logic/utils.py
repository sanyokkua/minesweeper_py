...
def get_neighbour_coordinates(current_coordinate: tuple[int, int],
    ...
    for row_modifier, column_modifier in coordinate_modifiers:
        ...
        is_not_valid_row: bool = ((neighbour_row < 0) or (neighbour_row >= number_of_rows))
        is_not_valid_col: bool = ((neighbour_col < 0) or (neighbour_col >= number_of_columns))
        ...
        if is_not_valid_row or is_not_valid_col or is_current_cell:
            log.debug('get_neighbour_coordinates.is_not_valid_row or is_not_valid_col or is_current_cell')
